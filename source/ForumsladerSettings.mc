...
class SettingsMenuDelegate extends WatchUi.Menu2InputDelegate {
    ...
    public function onSelect(item as MenuItem) as Void {
        ...
        if (id == :options) {
            ...
            WatchUi.pushView(menu, new $.SubMenuDelegate(), WatchUi.SLIDE_UP);
        } else if (id == :fields) {
            ...
            var drawable1 = new $.CustomIcon($.DisplayField1);
            var drawable2 = new $.CustomIcon($.DisplayField2);
            var drawable3 = new $.CustomIcon($.DisplayField3);
            var drawable4 = new $.CustomIcon($.DisplayField4);
