...
enum {
    ...
    LoggingField1, LoggingField2, LoggingField3, LoggingField4,     // user selected logging values
...
class SettingsMenu extends WatchUi.Menu2 {
    ...
    function initialize() {
        ...
        Menu2.addItem(new WatchUi.MenuItem(WatchUi.loadResource($.Rez.Strings.MenuDisplayfields) as String, null, :displayfields, null));
        Menu2.addItem(new WatchUi.MenuItem(WatchUi.loadResource($.Rez.Strings.MenuLoggingfields) as String, null, :loggingfields, null));
    }    
}
...
class SettingsMenuDelegate extends WatchUi.Menu2InputDelegate {
    ...
    public function onSelect(item as MenuItem) as Void {
        ...
        if (id == :options) {
        ...
        } else if (id == :displayfields) {
            // When the fields menu item is selected, push a new menu with picklists generated by custom icons
            var menu = new WatchUi.Menu2({:title=>WatchUi.loadResource($.Rez.Strings.MenuDisplayfields) as String});
            ...
            WatchUi.pushView(menu, new $.SubMenuDelegate(), WatchUi.SLIDE_IMMEDIATE);
        } else if (id == :loggingfields) {
            // When the fields menu item is selected, push a new menu with picklists generated by custom icons
            var menu = new WatchUi.Menu2({:title=>WatchUi.loadResource($.Rez.Strings.MenuLoggingfields) as String});
            var drawable1 = new $.PickList($.LoggingField1);
            var drawable2 = new $.PickList($.LoggingField2);
            var drawable3 = new $.PickList($.LoggingField3);
            var drawable4 = new $.PickList($.LoggingField4);
            menu.addItem(new WatchUi.IconMenuItem(drawable1.getString(), null, $.LoggingField1, drawable1, null));
            menu.addItem(new WatchUi.IconMenuItem(drawable2.getString(), null, $.LoggingField2, drawable2, null));
            menu.addItem(new WatchUi.IconMenuItem(drawable3.getString(), null, $.LoggingField3, drawable3, null));
            menu.addItem(new WatchUi.IconMenuItem(drawable4.getString(), null, $.LoggingField4, drawable4, null));
            WatchUi.pushView(menu, new $.SubMenuDelegate(), WatchUi.SLIDE_IMMEDIATE); 
        } else {
...
class SubMenuDelegate extends WatchUi.Menu2InputDelegate {
    ...
    public function onBack() as Void {
        ...
        Properties.setValue("UserSetting5", $.UserSettings[$.LoggingField1] as Number);
        Properties.setValue("UserSetting6", $.UserSettings[$.LoggingField2] as Number);
        Properties.setValue("UserSetting7", $.UserSettings[$.LoggingField3] as Number);
        Properties.setValue("UserSetting8", $.UserSettings[$.LoggingField4] as Number);
