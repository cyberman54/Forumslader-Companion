...
class SettingsMenuDelegate extends WatchUi.Menu2InputDelegate {
    ...
    public function onSelect(item as MenuItem) as Void {
        ...
        if (id == :options) {
            ...
            menu.addItem(new WatchUi.ToggleMenuItem(WatchUi.loadResource($.Rez.Strings.SelectFieldRolling) as String, 
                null, :fieldRoll, $.UserSettings[$.FieldRolling] as Boolean, null));
...
class SubMenuDelegate extends WatchUi.Menu2InputDelegate {
    ...
    public function onSelect(item as MenuItem) as Void {
        ...
        if (item instanceof WatchUi.ToggleMenuItem) {
            ...
            if (id == :fitLog) {
                ...
                $.UserSettings[$.FieldRolling] = item.isEnabled();
            }
        }
        WatchUi.requestUpdate();
    }
    ...
    public function onBack() as Void {
        ...
        Properties.setValue("FieldRolling", $.UserSettings[$.FieldRolling] as Boolean);
        // go back
        WatchUi.popView(WatchUi.SLIDE_IMMEDIATE);
    }
}
